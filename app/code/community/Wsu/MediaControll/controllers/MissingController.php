...
class Wsu_Mediacontroll_MissingController extends Mage_Adminhtml_Controller_action {
	...
	protected function _initAction() {
		$this->loadLayout()->_setActiveMenu('system/tools')
			...
			->_addBreadcrumb(Mage::helper('mediacontroll')->__('Missing Images'), Mage::helper('mediacontroll')->__('Sort assignment'));
    ...
    public function indexAction() {
        ...
        $this->_initAction()->_addContent($this->getLayout()->createBlock('mediacontroll/missing'));
