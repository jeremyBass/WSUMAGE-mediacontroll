...
class Wsu_Mediacontroll_Block_Imgclean_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	public function __construct() {
		...
		$this->_emptyText = Mage::helper('adminhtml')->__('No img found, try to refresh.<button title="Refresh" class="scalable refresh" onclick="setLocation(\''.$this->getUrl('*/*/search').'\')" type="button"><span><span><span>Refresh</span></span></span></button>');	  
	}
